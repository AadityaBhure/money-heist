...
function renderMinimap(fp,node){
  ...
  if(["q5","q6"].includes(node)){
    mapImage.src="./images/vault.png";
  ...
  if(fp==="FP1") mapImage.src="./images/a.png";
  if(fp==="FP2") mapImage.src=security.sec1?"./images/b1.png":"./images/b.png";
  if(fp==="FP3") mapImage.src="./images/c.png";
  if(fp==="FP4") mapImage.src=security.sec2?"./images/d1.png":"./images/d.png";
...
submitBtn.onclick = async()=>{
  ...
  if(node==="q4"){
    if(correct){
      return updateDoc(teamRef,{
        "progress.execution.currentNode":"q5"
      });
    }
    return;
  }
